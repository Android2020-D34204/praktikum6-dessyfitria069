...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pindah = findViewById(R.id.button);
        TextIsian = findViewById(R.id.editTextTextPersonName);

        pindah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String input  = TextIsian.getText().toString();
    ...
    public void send(){
        ...
        String CHANNEL_ID   = "Praktikum Dessy Fitria Virdayanti";
